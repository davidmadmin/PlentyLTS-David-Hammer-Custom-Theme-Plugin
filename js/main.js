(() => {
  ...
  (function(window2) {
    ...
    window2.HammerThemeHeader = window2.HammerThemeHeader || {};
    window2.HammerThemeHeader.onReady = onReady;
    window2.HammerThemeHeader.runOnce = runOnce;
  })(window);

  // resources/js/modules/header-fh.js
  function initHeaderFH() {
    ...
    runOnce("fh-header-module", function() {
        ...
        function installPriceToggle(priceToggleRoot, priceToggleButton) {
          ...
          const priceDisplayManager = (function() {
            ...
            function getCurrencyFormatter() {
              ...
              return function format(value, currency, fallback) {
                ...
                if (!formatter) {
                  ...
                  if (!formatter) {
                    const locale = typeof window !== "undefined" && window.App && (App.language || App.locale || App.defaultLocale) || "de-DE";
                    formatter = function(amount, isoCode) {
            ...
            function pickNumericValue(source, grossKey, netKey, showNet, fallback) {
              ...
              const net = netKey ? source[netKey] : void 0;
              if (showNet) {
            ...
            function updatePriceContainer(container2, showNet) {
              if (!container2 || typeof container2 !== "object") return;
              const raw = container2.data;
              if (!raw || typeof raw !== "object") return;
              const currency = raw.currency || container2.price && container2.price.currency || window.App && App.activeCurrency || "EUR";
              const priceValue = pickNumericValue(raw, "price", "priceNet", showNet, container2.price && container2.price.value);
              assignFormatted(container2.price, priceValue, currency, container2.price && container2.price.formatted);
              const unitPriceValue = pickNumericValue(raw, "unitPrice", "unitPriceNet", showNet, container2.unitPrice && container2.unitPrice.value);
              assignFormatted(container2.unitPrice, unitPriceValue, currency, container2.unitPrice && container2.unitPrice.formatted);
              if (Object.prototype.hasOwnProperty.call(container2, "totalPrice")) {
                const totalValue = pickNumericValue(raw, "totalPrice", "totalPriceNet", showNet, container2.totalPrice && container2.totalPrice.value);
                assignFormatted(container2.totalPrice, totalValue, currency, container2.totalPrice && container2.totalPrice.formatted);
              }
              if (Object.prototype.hasOwnProperty.call(container2, "lowestPrice")) {
                const lowestValue = pickNumericValue(raw, "lowestPrice", "lowestPriceNet", showNet, container2.lowestPrice && container2.lowestPrice.value);
                assignFormatted(container2.lowestPrice, lowestValue, currency, container2.lowestPrice && container2.lowestPrice.formatted);
              }
              if (Object.prototype.hasOwnProperty.call(container2, "basePrice")) {
                const baseValue = pickNumericValue(raw, "basePrice", "basePriceNet", showNet, null);
                if (typeof baseValue === "number" && isFinite(baseValue)) {
                  container2.basePrice = formatCurrency(baseValue, currency, container2.basePrice);
                }
              }
              if (container2.contactClassDiscount && Object.prototype.hasOwnProperty.call(container2.contactClassDiscount, "amount")) {
                const discountValue = pickNumericValue(raw, "customerClassDiscount", "customerClassDiscountNet", showNet, container2.contactClassDiscount.amount);
                if (typeof discountValue === "number" && isFinite(discountValue)) container2.contactClassDiscount.amount = discountValue;
              }
              if (container2.categoryDiscount && Object.prototype.hasOwnProperty.call(container2.categoryDiscount, "amount")) {
                const discountValue = pickNumericValue(raw, "categoryDiscount", "categoryDiscountNet", showNet, container2.categoryDiscount.amount);
                if (typeof discountValue === "number" && isFinite(discountValue)) container2.categoryDiscount.amount = discountValue;
              }
              container2.isNet = !!showNet;
            }
            ...
            function applyNow(store, showNet) {
              ...
              const seen = typeof WeakSet === "function" ? /* @__PURE__ */ new WeakSet() : null;
          ...
          function updateCategoryItemData(showNet) {
            ...
            const seenObjects = typeof WeakSet === "function" ? /* @__PURE__ */ new WeakSet() : null;
            ...
            categoryMutationObserver = new MutationObserver(function(mutations) {
              for (let index = 0; index < mutations.length; index += 1) {
                ...
                for (let nodeIndex = 0; nodeIndex < nodes.length; nodeIndex += 1) {
                  ...
                  if (node.classList && node.classList.contains("cmp-product-thumb") || typeof node.querySelector === "function" && node.querySelector(".cmp-product-thumb")) {
      ...
      onReady(function() {
        ...
        const panelElements = panelContainer ? Array.prototype.slice.call(panelContainer.querySelectorAll("[data-fh-mobile-panel]")) : [];
        ...
        const panelTitleMap = /* @__PURE__ */ new Map();
        const breadcrumbTargets = /* @__PURE__ */ new Map();
        ...
        function persistPanelStack() {
          ...
          try {
            const storage = window.localStorage;
            if (!storage) return;
            const path = panelStack.slice(1).map(function(entry) {
        ...
        function handleTrapFocus(event) {
          ...
          const focusableElements = Array.prototype.slice.call(menu.querySelectorAll(focusableSelectors)).filter(function(element) {
            return element instanceof HTMLElement && element.offsetParent !== null && !element.hasAttribute("disabled") && element.getAttribute("aria-hidden") !== "true";
          });
        ...
        function renderBreadcrumb(currentPanel, depth) {
          ...
          breadcrumbTargets.forEach(function(container2) {
        ...
        function resetPanels(options) {
          if (!panelContainer || panelElements.length === 0) return;
          const skipFocus = !!(options && options.skipFocus === true);
          panelStack.slice(1).forEach(function(entry) {
            if (entry && entry.trigger instanceof HTMLElement) entry.trigger.setAttribute("aria-expanded", "false");
          });
          panelStack = [{ id: ROOT_PANEL_ID, trigger: null }];
          updatePanelState({ skipFocus, preventRootFocus: true });
          persistPanelStack();
        }
        function openPanel(panelId, trigger, options) {
          ...
          if (existingIndex > -1) {
            panelStack.slice(existingIndex + 1).forEach(function(entry) {
              if (entry && entry.trigger instanceof HTMLElement) entry.trigger.setAttribute("aria-expanded", "false");
            });
        ...
        if (typeof desktopMedia.addEventListener === "function") desktopMedia.addEventListener("change", handleBreakpointChange);
      ...
      onReady(function() {
        ...
        const raf = typeof window.requestAnimationFrame === "function" ? window.requestAnimationFrame.bind(window) : function(callback) {
      ...
      onReady(function() {
        ...
        const cancelRaf = typeof window.cancelAnimationFrame === "function" ? window.cancelAnimationFrame.bind(window) : window.clearTimeout;
      ...
      onReady(function() {
        ...
        function refreshWishListItemsSilently(store) {
          ...
          window.ApiService.get("/rest/io/itemWishList").done(function(response) {
  ...
  // resources/js/modules/header-sh.js
  function initHeaderSH() {
    ...
    runOnce("sh-header-module", function() {
      ...
      onReady(function() {
        ...
        const panelElements = panelContainer ? Array.prototype.slice.call(panelContainer.querySelectorAll("[data-sh-mobile-panel]")) : [];
  ...
  (function bootstrapHeaders(window2) {
    const api = window2.HammerThemeHeader || {};
